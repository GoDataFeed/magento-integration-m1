 ...
 */
/**
 * Class GoDataFeed_Services_Model_Catalog_Product_Api retrieve data for request.
 * @package GoDataFeed_Services
 * @author yvechirko
 */
class GoDataFeed_Services_Model_Catalog_Product_Api
{
    /**
     * @var GoDataFeed_Services_Model_Catalog_Product_Count
     */
    protected $_countModel;

    /**
     * @var GoDataFeed_Services_Model_Catalog_Product_ExtendedList
     */
     ...
     *
     * @return GoDataFeed_Services_Model_Catalog_Product_Count
     */
	public function getCountModel()
	{
        if (is_null($this->_countModel)) {

            $this->_countModel = Mage::getModel('godatafeed_services/catalog_product_count');
        }
     ...
     *
     * @return GoDataFeed_Services_Model_Catalog_Product_ExtendedList
     */
	public function getExtendedListModel()
	{
        if (is_null($this->_extendedListModel)) {

            $this->_extendedListModel = Mage::getModel('godatafeed_services/catalog_product_extendedList');
        }
