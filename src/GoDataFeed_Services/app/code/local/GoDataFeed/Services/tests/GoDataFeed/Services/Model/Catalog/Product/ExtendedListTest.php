 ...
 */
/**
 * Class GoDataFeed_Services_Model_Catalog_Product_ExtendedListTest.
    ...
    extends GoDataFeed_Services_Model_Catalog_Product_AbstractBaseProductsData
{
    ...
    {
        $this->testedObject = Mage::getModel('godatafeed_services/catalog_product_extendedList');
    }
    ...
    protected function getCollectionStub()
    {
        ...
        $stub->method('getItems')
             ->willReturn(GoDataFeed_Services_Model_Catalog_Product_DataForTesting::getTestItems());
    ...
    public function testTestedObjectClass()
    {
        $this->assertInstanceOf(
                GoDataFeed_Services_Model_Catalog_Product_ExtendedList::class,
                $this->testedObject
            );
    }
    ...
    public function testExtendedList()
    {
        $result = $this->testedObject->extendedList(
                ...
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::STANDARD_ATTRIBUTES,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::CUSTOM_ATTRIBUTES,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::QTY_CONFIG,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::IS_IN_STOCK_CONFIG,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ATTR_SET_NAME_CONFIG,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::CATEGORY_BREADCRAMBS_CONFIG,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::MANUFACTURER_NAME_CONFIG,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ABS_URL_CONFIG,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ABS_IMAGE_URL_CONFIG,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::SCRUB_PRODUCT_NAME,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::SCRUB_DESCRIPTION,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::SCRUB_SHORT_DESCRIPTION,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::SCRUB_ATTR_SET_NAME,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::SCRUB_CUSTOM_ATTR,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::PAGE_NUMBER,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::PRODUCT_PER_PAGE,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::PARENT_SKU_CONFIG,
                GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ADDITIONAL_IMAGES_CONFIG
            );
    ...
    protected function checkCollectionAttirbutes($collection)
    {
        ...
        foreach (GoDataFeed_Services_Model_Catalog_Product_DataForTesting::FILTERS as $attr => $val) {
            $this->assertArrayHasKey($attr, $attributes);
        }

        foreach (GoDataFeed_Services_Model_Catalog_Product_DataForTesting::STANDARD_ATTRIBUTES as $attr) {
            $this->assertArrayHasKey($attr, $attributes);
        }

        foreach (GoDataFeed_Services_Model_Catalog_Product_DataForTesting::CUSTOM_ATTRIBUTES as $attr) {
            $this->assertArrayHasKey($attr, $attributes);
        }
    }
     ...
     * source data you can see GoDataFeed_Services_Model_Catalog_Product_DataForTesting::getTestItems().
     *
     * @param array $result
     * @return void
     */
    ...
    protected function checkStockData($result)
    {
        $this->assertEquals(
                self::STOCK_QTY,
                $result[0][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::QTY_CONFIG[1]]
            );
        $this->assertEquals(
                self::IS_IN_STOCK,
                $result[1][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::IS_IN_STOCK_CONFIG[1]]
            );
    }
    ...
    protected function checkAttrSetData($result)
    {
        $this->assertEquals(
            ...
            $result[0][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ATTR_SET_NAME_CONFIG[1]]
        );
    }
    ...
    protected function checkCategoryData($result)
    {
        $this->assertEquals(
            ...
            $result[0][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::CATEGORY_BREADCRAMBS_CONFIG[1]]
        );
    }
    ...
    protected function checkManufacturerData($result)
    {
        $this->assertEquals(
            '',
            $result[0][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::MANUFACTURER_NAME_CONFIG[1]]
        );
    }
     ...
     * in GoDataFeed_Services_Model_Catalog_Product_ExtendedList::getUrlAndImage().
     *
     * @param array $result
     * @return void
     */
    protected function checkUrlAndImage($result)
    {
        ...
        $this->assertEquals(
                $baseUrl . 'url_path',
                $result[0][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ABS_URL_CONFIG[1]]
            );
        ...
        $this->assertEquals(
                ...
                $result[0][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::PARENT_SKU_CONFIG[1]]
            );
        ...
        $this->assertEquals(
                ...
                $result[1][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ABS_URL_CONFIG[1]]
            );
        $this->assertEquals(
                $imageBaseURL . '/image',
                $result[1][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ABS_IMAGE_URL_CONFIG[1]]
            );
        $this->assertEquals(
                $imageBaseURL . self::TEST_PARENT_IMAGE,
                $result[2][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ABS_IMAGE_URL_CONFIG[1]]
            );
    }
    ...
    protected function checkAdditionalImage($result)
    {
        $this->assertEquals(
                ...
                $result[0][GoDataFeed_Services_Model_Catalog_Product_DataForTesting::ADDITIONAL_IMAGES_CONFIG[1]]
            );
    }
}
