 ...
 */
/**
 * Class GoDataFeed_Services_Model_Version_ApiTest.
 * @package GoDataFeed_Services
 * @author yvechirko
 */
class GoDataFeed_Services_Model_Version_ApiTest extends PHPUnit_Framework_TestCase
{
    /**
     * Tested object.
     *
    ...
    {
       $this->versionApi = Mage::getModel('godatafeed_services/version_api');
    }
    ...
    public function testVersionApiClass()
    {
        $this->assertInstanceOf(
            GoDataFeed_Services_Model_Version_Api::class,
            $this->versionApi
        );
    }
    ...
    {
        return (string) Mage::getConfig()->getNode()->modules->GoDataFeed_Services->version;
    }
}
