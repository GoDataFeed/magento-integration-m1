...
/**
 * Class GoDataFeed_Services_Model_Catalog_Product_AbstractBaseProductsData.
 * @package GoDataFeed_Services
 * @author  yvechirko
 */
abstract class GoDataFeed_Services_Model_Catalog_Product_AbstractBaseProductsData extends PHPUnit_Framework_TestCase
{
    /**
     * Tested object.
     *
    ...
    protected function checkQtyFilter($collection)
    {
        ...
        $this->assertNotEquals(
            ...
            stripos(
                $queryString,
                'qty >= ' . GoDataFeed_Services_Model_Catalog_Product_DataForTesting::QUANTITY_FILTER_AMOUNT
            )
        );
    }
    ...
    {
        $queryString = $collection->getSelect()->__toString();
        $attr = key(GoDataFeed_Services_Model_Catalog_Product_DataForTesting::FILTERS);
        $val = GoDataFeed_Services_Model_Catalog_Product_DataForTesting::FILTERS[$attr]['eq'];
