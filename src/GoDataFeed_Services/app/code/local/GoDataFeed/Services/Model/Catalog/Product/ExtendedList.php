 ...
 */
/**
 * Class GoDataFeed_Services_Model_Catalog_Product_ExtendedList retrieve data of products.
 * @package GoDataFeed_Services
 * @author yvechirko
 */
class GoDataFeed_Services_Model_Catalog_Product_ExtendedList
    extends GoDataFeed_Services_Model_Catalog_Product_BaseProductsData
{
    /**
     * @var string
     */
